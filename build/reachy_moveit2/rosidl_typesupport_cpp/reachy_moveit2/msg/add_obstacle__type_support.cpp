...
static const _AddObstacle_type_support_symbol_names_t _AddObstacle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reachy_moveit2, msg, AddObstacle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reachy_moveit2, msg, AddObstacle)),
  }
};
...
{
  return &::reachy_moveit2::msg::rosidl_typesupport_cpp::AddObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, reachy_moveit2, msg, AddObstacle)() {
  return get_message_type_support_handle<reachy_moveit2::msg::AddObstacle>();
}
