...
static const _SetDataToDxl_Request_type_support_symbol_names_t _SetDataToDxl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_interfaces, srv, SetDataToDxl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_interfaces, srv, SetDataToDxl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_interfaces, srv, SetDataToDxl_Request)() {
  return &::dynamixel_interfaces::srv::rosidl_typesupport_c::SetDataToDxl_Request_message_type_support_handle;
}
...
static const _SetDataToDxl_Response_type_support_symbol_names_t _SetDataToDxl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_interfaces, srv, SetDataToDxl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_interfaces, srv, SetDataToDxl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_interfaces, srv, SetDataToDxl_Response)() {
  return &::dynamixel_interfaces::srv::rosidl_typesupport_c::SetDataToDxl_Response_message_type_support_handle;
}
...
static const _SetDataToDxl_type_support_symbol_names_t _SetDataToDxl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_interfaces, srv, SetDataToDxl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_interfaces, srv, SetDataToDxl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_interfaces, srv, SetDataToDxl)() {
  return &::dynamixel_interfaces::srv::rosidl_typesupport_c::SetDataToDxl_service_type_support_handle;
}
