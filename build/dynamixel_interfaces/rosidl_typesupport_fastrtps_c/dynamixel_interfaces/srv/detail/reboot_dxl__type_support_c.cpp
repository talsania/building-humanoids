  ...
  void * untyped_ros_message)
{
  ...
  _RebootDxl_Request__ros_msg_type * ros_message = static_cast<_RebootDxl_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _RebootDxl_Response__ros_msg_type * ros_message = static_cast<_RebootDxl_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
    uint8_t tmp;
    cdr >> tmp;
