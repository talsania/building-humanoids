...
class Metaclass_SpawnBatch(type):
    """Metaclass of message 'SpawnBatch'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.msg.SpawnBatch')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__spawn_batch
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__spawn_batch
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__spawn_batch
            cls._TYPE_SUPPORT = module.type_support_msg__msg__spawn_batch
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__spawn_batch
...
class SpawnBatch(metaclass=Metaclass_SpawnBatch):
    """Message class 'SpawnBatch'."""
