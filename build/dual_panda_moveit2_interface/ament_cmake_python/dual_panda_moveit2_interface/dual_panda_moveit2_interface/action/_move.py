    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_Goal')
            logger.debug(
...
class Move_Goal(metaclass=Metaclass_Move_Goal):
    ...
    _fields_and_field_types = {
        'use_joint_state': 'boolean',
        'head_pose': 'geometry_msgs/Pose',
        'left_pose': 'geometry_msgs/Pose',
        'right_pose': 'geometry_msgs/Pose',
        'joint_values': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.use_joint_state = kwargs.get('use_joint_state', bool())
        from geometry_msgs.msg import Pose
        self.head_pose = kwargs.get('head_pose', Pose())
        from geometry_msgs.msg import Pose
        self.left_pose = kwargs.get('left_pose', Pose())
        from geometry_msgs.msg import Pose
        self.right_pose = kwargs.get('right_pose', Pose())
        self.joint_values = array.array('d', kwargs.get('joint_values', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.use_joint_state != other.use_joint_state:
            return False
        if self.head_pose != other.head_pose:
            return False
        if self.left_pose != other.left_pose:
            return False
        if self.right_pose != other.right_pose:
            return False
        if self.joint_values != other.joint_values:
            return False
        return True
    ...
    @builtins.property
    def use_joint_state(self):
        """Message field 'use_joint_state'."""
        return self._use_joint_state

    @use_joint_state.setter
    def use_joint_state(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'use_joint_state' field must be of type 'bool'"
        self._use_joint_state = value
    ...
    @builtins.property
    def left_pose(self):
        """Message field 'left_pose'."""
        return self._left_pose

    @left_pose.setter
    def left_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'left_pose' field must be a sub message of type 'Pose'"
        self._left_pose = value

    @builtins.property
    def right_pose(self):
        """Message field 'right_pose'."""
        return self._right_pose

    @right_pose.setter
    def right_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'right_pose' field must be a sub message of type 'Pose'"
        self._right_pose = value

    @builtins.property
    def joint_values(self):
        """Message field 'joint_values'."""
        return self._joint_values

    @joint_values.setter
    def joint_values(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'joint_values' array.array() must have the type code of 'd'"
            self._joint_values = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'joint_values' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._joint_values = array.array('d', value)
...
class Metaclass_Move_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dual_panda_moveit2_interface.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'dual_panda_moveit2_interface/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dual_panda_moveit2_interface', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from dual_panda_moveit2_interface.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dual_panda_moveit2_interface.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from dual_panda_moveit2_interface.action._move import Move_SendGoal_Request as Request
    from dual_panda_moveit2_interface.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'dual_panda_moveit2_interface/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dual_panda_moveit2_interface', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from dual_panda_moveit2_interface.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from dual_panda_moveit2_interface.action._move import Move_GetResult_Request as Request
    from dual_panda_moveit2_interface.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'dual_panda_moveit2_interface/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dual_panda_moveit2_interface', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from dual_panda_moveit2_interface.action._move import Move_Feedback
...
class Metaclass_Move(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dual_panda_moveit2_interface.action.Move')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move(metaclass=Metaclass_Move):
    ...
    from dual_panda_moveit2_interface.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from dual_panda_moveit2_interface.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from dual_panda_moveit2_interface.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from dual_panda_moveit2_interface.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from dual_panda_moveit2_interface.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from dual_panda_moveit2_interface.action._move import Move_FeedbackMessage as FeedbackMessage
