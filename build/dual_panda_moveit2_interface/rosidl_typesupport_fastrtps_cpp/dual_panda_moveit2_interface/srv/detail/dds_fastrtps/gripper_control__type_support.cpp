...
#include "dual_panda_moveit2_interface/srv/detail/gripper_control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dual_panda_moveit2_interface::srv::GripperControl_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dual_panda_moveit2_interface::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dual_panda_moveit2_interface::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  return &dual_panda_moveit2_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dual_panda_moveit2_interface::srv::GripperControl_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dual_panda_moveit2_interface::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dual_panda_moveit2_interface::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dual_panda_moveit2_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Response__handle;
}
...
{
  return &dual_panda_moveit2_interface::srv::typesupport_fastrtps_cpp::_GripperControl__handle;
}
