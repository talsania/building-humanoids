...
#include "dual_panda_moveit2_interface/msg/detail/spawn_batch__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dual_panda_moveit2_interface::msg::SpawnBatch;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dual_panda_moveit2_interface::msg::SpawnBatch *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dual_panda_moveit2_interface::msg::SpawnBatch *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpawnBatch__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dual_panda_moveit2_interface::msg::SpawnBatch *>(
...
static size_t _SpawnBatch__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpawnBatch(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpawnBatch__callbacks = {
...
static rosidl_message_type_support_t _SpawnBatch__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpawnBatch__callbacks,
...
{
  return &dual_panda_moveit2_interface::msg::typesupport_fastrtps_cpp::_SpawnBatch__handle;
}
