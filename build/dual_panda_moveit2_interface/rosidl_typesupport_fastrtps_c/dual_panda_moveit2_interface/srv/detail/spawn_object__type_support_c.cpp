...
#include "dual_panda_moveit2_interface/srv/detail/spawn_object__rosidl_typesupport_fastrtps_c.h"
...
#include "dual_panda_moveit2_interface/msg/detail/object_spec__functions.h"  // objects

// forward declare type support functions
size_t get_serialized_size_dual_panda_moveit2_interface__msg__ObjectSpec(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_dual_panda_moveit2_interface__msg__ObjectSpec(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_panda_moveit2_interface, msg, ObjectSpec)();


using _SpawnObject_Request__ros_msg_type = dual_panda_moveit2_interface__srv__SpawnObject_Request;
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, dual_panda_moveit2_interface, msg, ObjectSpec
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      dual_panda_moveit2_interface__msg__ObjectSpec__Sequence__fini(&ros_message->objects);
    }
...
size_t get_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpawnObject_Request__ros_msg_type * ros_message = static_cast<const _SpawnObject_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_dual_panda_moveit2_interface__msg__ObjectSpec(
...
static uint32_t _SpawnObject_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dual_panda_moveit2_interface
size_t max_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_dual_panda_moveit2_interface__msg__ObjectSpec(
  ...
  if (is_plain) {
    ...
    using DataType = dual_panda_moveit2_interface__srv__SpawnObject_Request;
    is_plain =
      (
...
static size_t _SpawnObject_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_panda_moveit2_interface, srv, SpawnObject_Request)() {
...
// already included above
// #include "dual_panda_moveit2_interface/msg/detail/object_spec__functions.h"  // current_objects
...
using _SpawnObject_Response__ros_msg_type = dual_panda_moveit2_interface__srv__SpawnObject_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: current_objects
  {
    ...
    auto array_ptr = ros_message->current_objects.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: current_objects
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->current_objects.data) {
      dual_panda_moveit2_interface__msg__ObjectSpec__Sequence__fini(&ros_message->current_objects);
    }
    if (!dual_panda_moveit2_interface__msg__ObjectSpec__Sequence__init(&ros_message->current_objects, size)) {
      fprintf(stderr, "failed to create array for field 'current_objects'");
      return false;
    }
    auto array_ptr = ros_message->current_objects.data;
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dual_panda_moveit2_interface
size_t get_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpawnObject_Response__ros_msg_type * ros_message = static_cast<const _SpawnObject_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dual_panda_moveit2_interface
size_t max_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dual_panda_moveit2_interface__srv__SpawnObject_Response;
    is_plain =
      (
...
static size_t _SpawnObject_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dual_panda_moveit2_interface__srv__SpawnObject_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_panda_moveit2_interface, srv, SpawnObject_Response)() {
...
// already included above
// #include "dual_panda_moveit2_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dual_panda_moveit2_interface/srv/spawn_object.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dual_panda_moveit2_interface, srv, SpawnObject)() {
