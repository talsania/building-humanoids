...
#include "dual_panda_moveit2_interface/msg/detail/robot_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // head, left_pose, right_pose
...
using _RobotPose__ros_msg_type = dual_panda_moveit2_interface__msg__RobotPose;
...
static uint32_t _RobotPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dual_panda_moveit2_interface__msg__RobotPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dual_panda_moveit2_interface__msg__RobotPose;
    is_plain =
      (
...
static size_t _RobotPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dual_panda_moveit2_interface__msg__RobotPose(
