...
static const _SpawnBatch_type_support_symbol_names_t _SpawnBatch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, msg, SpawnBatch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, msg, SpawnBatch)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::msg::rosidl_typesupport_cpp::SpawnBatch_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, msg, SpawnBatch)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::msg::SpawnBatch>();
}
