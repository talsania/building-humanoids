...
static const _GripperControl_Request_type_support_symbol_names_t _GripperControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, GripperControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, GripperControl_Request)),
  }
};
...
get_message_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl_Request>()
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::GripperControl_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, GripperControl_Request)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl_Request>();
}
...
static const _GripperControl_Response_type_support_symbol_names_t _GripperControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, GripperControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, GripperControl_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl_Response>()
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::GripperControl_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, GripperControl_Response)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl_Response>();
}
...
static const _GripperControl_type_support_symbol_names_t _GripperControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, GripperControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, GripperControl)),
  }
};
...
get_service_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl>()
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::GripperControl_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, GripperControl)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dual_panda_moveit2_interface::srv::GripperControl>();
}
