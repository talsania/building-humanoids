...
static const _RemoveObject_Request_type_support_symbol_names_t _RemoveObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Request)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::RemoveObject_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Request)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::RemoveObject_Request>();
}
...
static const _RemoveObject_Response_type_support_symbol_names_t _RemoveObject_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Response)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::RemoveObject_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, RemoveObject_Response)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::RemoveObject_Response>();
}
...
static const _RemoveObject_type_support_symbol_names_t _RemoveObject_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, RemoveObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, RemoveObject)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::RemoveObject_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, RemoveObject)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dual_panda_moveit2_interface::srv::RemoveObject>();
}
