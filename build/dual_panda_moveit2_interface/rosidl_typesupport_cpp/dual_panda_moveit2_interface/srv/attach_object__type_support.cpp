...
static const _AttachObject_Request_type_support_symbol_names_t _AttachObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, AttachObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, AttachObject_Request)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::AttachObject_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, AttachObject_Request)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::AttachObject_Request>();
}
...
static const _AttachObject_Response_type_support_symbol_names_t _AttachObject_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, AttachObject_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, AttachObject_Response)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::AttachObject_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, AttachObject_Response)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::AttachObject_Response>();
}
...
static const _AttachObject_type_support_symbol_names_t _AttachObject_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, AttachObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, AttachObject)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::AttachObject_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, AttachObject)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dual_panda_moveit2_interface::srv::AttachObject>();
}
