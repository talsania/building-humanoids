...
static const _SpawnObject_Request_type_support_symbol_names_t _SpawnObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Request)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::SpawnObject_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Request)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::SpawnObject_Request>();
}
...
static const _SpawnObject_Response_type_support_symbol_names_t _SpawnObject_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Response)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::SpawnObject_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, SpawnObject_Response)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::SpawnObject_Response>();
}
...
static const _SpawnObject_type_support_symbol_names_t _SpawnObject_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, SpawnObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, SpawnObject)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::SpawnObject_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, SpawnObject)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dual_panda_moveit2_interface::srv::SpawnObject>();
}
