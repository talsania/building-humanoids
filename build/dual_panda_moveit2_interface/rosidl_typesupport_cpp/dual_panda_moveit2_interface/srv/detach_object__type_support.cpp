...
static const _DetachObject_Request_type_support_symbol_names_t _DetachObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, DetachObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, DetachObject_Request)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::DetachObject_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, DetachObject_Request)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::DetachObject_Request>();
}
...
static const _DetachObject_Response_type_support_symbol_names_t _DetachObject_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, DetachObject_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, DetachObject_Response)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::DetachObject_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, DetachObject_Response)() {
  return get_message_type_support_handle<dual_panda_moveit2_interface::srv::DetachObject_Response>();
}
...
static const _DetachObject_type_support_symbol_names_t _DetachObject_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dual_panda_moveit2_interface, srv, DetachObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dual_panda_moveit2_interface, srv, DetachObject)),
  }
};
...
{
  return &::dual_panda_moveit2_interface::srv::rosidl_typesupport_cpp::DetachObject_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dual_panda_moveit2_interface, srv, DetachObject)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dual_panda_moveit2_interface::srv::DetachObject>();
}
