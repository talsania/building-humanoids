...
dual_panda_moveit2_interface__srv__DetachObject_Request__init(dual_panda_moveit2_interface__srv__DetachObject_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->id)) {
    dual_panda_moveit2_interface__srv__DetachObject_Request__fini(msg);
    return false;
  }
  return true;
}
...
dual_panda_moveit2_interface__srv__DetachObject_Request__create()
{
  ...
  dual_panda_moveit2_interface__srv__DetachObject_Request * msg = (dual_panda_moveit2_interface__srv__DetachObject_Request *)allocator.allocate(sizeof(dual_panda_moveit2_interface__srv__DetachObject_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dual_panda_moveit2_interface__srv__DetachObject_Request));
  bool success = dual_panda_moveit2_interface__srv__DetachObject_Request__init(msg);
  if (!success) {
...
dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__init(dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dual_panda_moveit2_interface__srv__DetachObject_Request * data = NULL;

  if (size) {
    data = (dual_panda_moveit2_interface__srv__DetachObject_Request *)allocator.zero_allocate(size, sizeof(dual_panda_moveit2_interface__srv__DetachObject_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dual_panda_moveit2_interface__srv__DetachObject_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dual_panda_moveit2_interface__srv__DetachObject_Request__fini(&data[i - 1]);
      }
...
dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__fini(dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dual_panda_moveit2_interface__srv__DetachObject_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * array = (dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence *)allocator.allocate(sizeof(dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__init(array, size);
  if (!success) {
...
dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__destroy(dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence__are_equal(const dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * lhs, const dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dual_panda_moveit2_interface__srv__DetachObject_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dual_panda_moveit2_interface__srv__DetachObject_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dual_panda_moveit2_interface__srv__DetachObject_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dual_panda_moveit2_interface__srv__DetachObject_Request * data =
      (dual_panda_moveit2_interface__srv__DetachObject_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dual_panda_moveit2_interface__srv__DetachObject_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dual_panda_moveit2_interface__srv__DetachObject_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dual_panda_moveit2_interface__srv__DetachObject_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dual_panda_moveit2_interface__srv__DetachObject_Response * msg = (dual_panda_moveit2_interface__srv__DetachObject_Response *)allocator.allocate(sizeof(dual_panda_moveit2_interface__srv__DetachObject_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dual_panda_moveit2_interface__srv__DetachObject_Response));
  bool success = dual_panda_moveit2_interface__srv__DetachObject_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
dual_panda_moveit2_interface__srv__DetachObject_Response__destroy(dual_panda_moveit2_interface__srv__DetachObject_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dual_panda_moveit2_interface__srv__DetachObject_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__init(dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dual_panda_moveit2_interface__srv__DetachObject_Response * data = NULL;

  if (size) {
    data = (dual_panda_moveit2_interface__srv__DetachObject_Response *)allocator.zero_allocate(size, sizeof(dual_panda_moveit2_interface__srv__DetachObject_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dual_panda_moveit2_interface__srv__DetachObject_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dual_panda_moveit2_interface__srv__DetachObject_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__fini(dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dual_panda_moveit2_interface__srv__DetachObject_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * array = (dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence *)allocator.allocate(sizeof(dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__destroy(dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence__are_equal(const dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * lhs, const dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dual_panda_moveit2_interface__srv__DetachObject_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dual_panda_moveit2_interface__srv__DetachObject_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dual_panda_moveit2_interface__srv__DetachObject_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dual_panda_moveit2_interface__srv__DetachObject_Response * data =
      (dual_panda_moveit2_interface__srv__DetachObject_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dual_panda_moveit2_interface__srv__DetachObject_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dual_panda_moveit2_interface__srv__DetachObject_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dual_panda_moveit2_interface__srv__DetachObject_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
