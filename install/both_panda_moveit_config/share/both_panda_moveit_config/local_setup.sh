...
: ${AMENT_CURRENT_PREFIX:="/home/kptal/humanoid_ws/install/both_panda_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/both_panda_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/both_panda_moveit_config/environment/path.sh"
